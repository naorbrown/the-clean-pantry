...
tldr:
  - "Many oils toxic to cats — tea tree, eucalyptus, peppermint"
  - "Dilute before skin contact; never ingest essential oils"
  - "Keep diffuser sessions short and ventilate the room"
