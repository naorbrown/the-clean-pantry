...
tldr:
  - "Removes dirt, pollen, and sunscreen residue from patio furniture"
  - "Vinegar and castile soap in a simple spray-and-scrub formula"
  - "Safe for plastic, resin, painted metal, and composite surfaces"
